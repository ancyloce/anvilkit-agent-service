...
func TestEveryStateByEveryCommandMatchesExactMatrix(t *testing.T) {
	expected := map[State]map[CommandKind]State{
		...
		AwaitingInput:              {AcceptInput: Planning, RequestCancellation: Cancelling},
		...
		AwaitingApproval:           {Approve: Committing, RejectApproval: AwaitingReview, RequestCancellation: Cancelling},
